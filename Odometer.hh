...
namespace custom
{
  ...
  class Odometer : public ignition::sensors::Sensor
  {
    public:
         ...
         * 
         * @return True if loading parameters.
         */
        ...
        /**
         * @brief Set the current position of the robot, so the odometer can calculate the distance travelled.
         * @param[in] _pos Current position in world coordinates.
         */
        void NewPosition(const ignition::math::Vector3d &_pos);

        /**
         * @brief Get the latest world position of the robot.
         * 
    ...
    private:
         ...
         */
        ignition::math::Vector3d prevPos{std::nan(""), std::nan(""),
            std::nan("")};
